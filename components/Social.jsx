...
const socials = [
  { icon: <FaLinkedin />, path: "https://www.linkedin.com/in/guer98/" },
  { icon: <FaGithub />, path: "https://github.com/Guer1298" },
  { icon: <FaInstagram />, path: "https://www.instagram.com/guer.98/" },
];
