...
export const blogs = [
    {
      slug: "from-idea-to-deploy",  // este será el nombre de la carpeta en [slug]
      num: "01",
    ...
    {
      slug: "github-actions-cicd",  // este será el nombre de la carpeta en [slug]
      num: "02",
    ...
    {
      slug: "scrum-kanban-notion",  // este será el nombre de la carpeta en [slug]
      num: "03",
    ...
    {
      slug: "authentication-challenges",  // este será el nombre de la carpeta en [slug]
      num: "04",
    ...
    {
      slug: "brand-growth",  // este será el nombre de la carpeta en [slug]
      num: "05",
